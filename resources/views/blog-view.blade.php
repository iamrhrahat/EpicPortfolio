...
<div><div class="container py-6 md:py-10">
    <div class="mx-auto max-w-4xl">
      <div class="">
        ...
        <img class="flex h-full w-full bg-cover bg-center bg-no-repeat sm:h-84 lg:h-64 xl:h-full" src="{{asset ('storage/' . $blogPost->thumbnail)}}" />
    </div>
        ...
        <div class="flex items-center pt-5 md:pt-10">
          ...
          <div class="pl-5">
            ...
            <span class="block pt-1 font-body text-xl font-bold text-grey-30"
              >{{$blogPost->getFormattedDate()}}</span
            >
          </div>
        </div>
      </div>
